...
export const getCharacterDetails = async (characterId: number): Promise<ICharacter> => {
...
export const useCharacterDetails = ({ characterId, config = {} }: useCharacterDetailsOptions) => {
  ...
  return useQuery<ICharacter>(['character', characterId], () => getCharacterDetails(characterId), {
    ...config,
  });
};
